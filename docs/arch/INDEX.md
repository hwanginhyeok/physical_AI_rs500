...
> 새 ADR 추가 시 이 파일에도 등록한다.
> 관리 규칙: `.claude/rules/arch-management.md`
>
> **전체 시스템 개요**: [SYSTEM_OVERVIEW.md](SYSTEM_OVERVIEW.md) (Living Document — 시스템 구조 변경 시 함께 갱신)

| # | 제목 | 상태 | 결정일 | 관련 TASK |
|---|------|------|--------|-----------|
| [ARCH-001](ARCH-001_tf_tree.md) | TF 트리 구조 | 채택됨 | 2026-03-01 | C50, C54, C55 |
